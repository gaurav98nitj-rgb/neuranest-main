                      ...
                      >
                        <div style={{ flex: 1 }}>
                          <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 4 }}>
                            ...
                            <Badge color={difficultyColorMap[p.launchDifficulty] || '#8B8479'}>
                              {p.launchDifficulty} Launch
                            </Badge>
                          </div>
                      ...
                      <div style={{ padding: '18px 24px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
                        <div>
                          <div style={{ marginBottom: 16 }}>
                            <div style={{ fontSize: 11, fontWeight: 600, color: '#8B8479', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: 6 }}>
